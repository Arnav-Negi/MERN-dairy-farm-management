...
export default function InteractiveCard(props) {
  ...
  async function handleCountAdd(){
    ...
    setEditting(false) 
    // setTimeout(() => setEditting(false), 1000)
...
props.delete(props.item.product._id)
  ...
  return (
    ...
    >
      <Checkbox 
      defaultChecked={props.item.checkStat}
      onClick = {() => {props.check(props.item)}}
      />
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: 1, justifyContent: 'flex-end', pt: 2 }}>
            ...
            <Button variant="solid" color="danger" onClick={handleRemoveProduct}>
              Remove
            </Button>
          </Box>
        </ModalDialog>
